        ...
        <div class="col-12">
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
						<c:forEach items="${commandeFilms}" var="commandeFilm">
			             	<tr>
	                            <td>
	                            	<img src="${commandeFilm.film.urlAffiche}"width="50" height="50" />
	                            </td>
	                            ...
	                            <td class="text-right">
		                            <a href="<c:url value="/accesrestreint/deletemovie">
										...
										<c:param name="idpanier" value="${idpanier}"/></c:url>">
				...
				<c:choose>	
					...
					<c:when test="${empty commandeFilms}">Votre panier est vide	</c:when>
				</c:choose>
      		</div>
        </div>
    </div>
