...
<div class="container">
        ...
        <div class="col-sm-5">
            ...
            <table class="table table-striped table-hover">
	                	...
	                	<c:if test="${user.role.nomRole=='Admin' }">	
							...
							<td>
	                            <a href="<c:url value="/admin/deleteUser">
									<c:param name="idutilisateur" value="${user.idUtilisateur}"/></c:url>" class="delete" title="Delete" data-toggle="tooltip">
           	...
           	<div class="col-sm-7">
				<a href="<c:url value="/registerForms"/>" class="btn btn-primary">
                ...
                <tbody>
	                <c:forEach items="${listUtilisateur}" var="user" varStatus="status">
	                	<c:if test="${user.role.nomRole=='Comptable' }">
	                        ...
	                        <td>${user.role.nomRole}</td>
							<td>
	                            <a href="<c:url value="/admin/deleteUser"><c:param name="idutilisateur" value="${user.idUtilisateur}"/>
									</c:url>" class="delete" title="Delete" data-toggle="tooltip">
									<i class="fa fa-trash" style="color:red" aria-hidden="true"></i>
								</a>
							</td>
							<tr>
