                ...
                <tbody>
	                <c:forEach items="${filmList}" var="film" varStatus="status">
	                	<c:if test="${film.metrage=='long' }">
	                        ...
	                        <td>
	                        	<a href="#">
	                        		<img src="${pageContext.request.contextPath}/inc/images/avatars/avatar.png" width="35" height="35"class="avatar" alt="Avatar">${film.numIsan}
	                        	</a>
                        	</td>
							...
							<td>
		                        <a href="<c:url value="/accesrestreint/detailsfilm">
									<c:param name="idfilm" value="${film.idFilm}"/></c:url>">
									<button class="btn btn-sm btn-info"><i class="fa fa-info-circle"></i></button>
		                        </a>
		                        
		                        <a href="<c:url value="/admin/adddatafilm">
									<c:param name="idfilm" value="${film.idFilm}"/></c:url>">
	          	...
	          	<div class="col-sm-7">
					<a href="<c:url value="/admin/filmAdmin"/>" class="btn btn-primary"><i class="fa fa-plus"></i> <span>Ajouter un film</span></a>				
				</div> 
				<br>
				<hr class="hr-light my-4 w-75">
	       		<div class="col-sm-5">
	            ...
	            <table class="table table-striped table-hover">
	                ...
	                <c:forEach items="${filmList}" var="film" varStatus="status">
	                	<c:if test="${film.metrage=='court' }">
	                        ...
	                        <td>
	                        	<a href="#">
	                        		<img src="${pageContext.request.contextPath}/inc/images/avatars/avatar.png" width="35" height="35"class="avatar" alt="Avatar">
	                        			${film.numIsan}
	                        	</a>
	                        </td>
	                        <td>${film.titreOriginal}</td>
				    ...
				    <!-- Card image -->
				    	...
				    	<div class="card-body card-body-cascade text-center">		
				      		...
				      		<div class="collapse-content">
			      				...
			      				<a class="nav-link" href=" <c:url value="/accesrestreint/detailsfilm?idfilm=${film.idFilm}"/>" >
